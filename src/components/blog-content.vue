       ...
       <el-row class="art-item">
          ...
          <el-row class="art-info d-flex align-items-center justify-content-start">
            ...
            <div class="d-flex align-items-center">
              <img class="tag" :src="imgTag">:
              <el-tag size="mini" :style="{marginLeft: '10px'}">Swagger2</el-tag>
            </div>
          </el-row>
          <el-row class="art-body">
            <div class="side-img hidden-sm-and-down">
              <img class="art-banner" :src="imgVue" alt="">
            </div>
...
export default {
  data() {
    return {
      imgTag: require('@/assets/tag.png'),
			imgVue: require('@/assets/vue.jpg'),
			imgStar: require('@/assets/star.png')
    }
  }  
}
</script>
